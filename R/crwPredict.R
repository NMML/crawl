...
#' \code{predTime}.}
#' 
#' \item{alpha.hat.y}{A data.frame with predicted state values for each time.
#' First column in latitude location (\code{mu.y}), second in velocity
#' (\code{nu.y} or \code{theta.y} for drift models), and third is drift
