...
subtitle: "Modeling Animal Movement by Example\n"
...
* employs a course speed filter using the [argosfilter](https://cran.r-project.org/web/packages/argosfilter/index.html) package
...
Some initial tidying of the data has been done prior to inclusion with the package. [dplyr](https://cran.rstudio.com/web/packages/dplyr/vignettes/introduction.html) was used for this process and this resulted in a `tbl_df` object. 
...
### Plot the output
Using ggplot, look at the predicted movement path. We will create a custom ggplot theme to provide a mapping look and feel.
